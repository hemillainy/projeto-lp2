...
public class Facade {
	 ...
	 * @param valor para substituir o valor antigo do atributo.
	 */
	 ...
	 * @param nome do usuario.
	 * @param telefone do usuario.
	 * @param nomeItem a ser cadastrado.
	 * @param preco do jogo eletronico.
	 * @param plataforma do jogo eletronico.
	 */
	 ...
	 * @param classificacao indicativa do filme.
	 ...
	 * @param nome do usuario.
	 * @param telefone do usuario.
	 * @param nomeBluRayTemporada a ser cadastrado o BluRay.
	 ...
	 * @param nome do usuario.
	 * @param telefone do usuario.
	 * @param nomeItem a ser adicionada a peca.
	 * @param nomePeca a ser adicionada como perdida.
	 */
	 ...
	 * @param nome do usuario.
	 * @param telefone do usuario.
	 * @param nomeItem que se deseja pegar a informacao.
	 * @param atributo que se deseja visualizar.
	 ...
	 * @param nome do usuario.
	 * @param telefone do usuario.
	 * @param nomeItem a ser alterado.
	 * @param atributo que se deseja alterar.
	 * @param valor para substituir o valor antigo do atributo.
	 */
	 ...
	 * @param nome do usuario.
	 * @param telefone do usuario.
	 * @param nomeItem a ser pesquisado.
	 ...
	 * @param nomeDono do item.
	 * @param telefoneDono do item.
	 * @param nomeRequerente do emprestimo.
	 * @param telefoneRequerente do emprestimo.
	 * @param nomeItem a ser emprestado.
	 * @param dataEmprestimo que houve o emprestimo.
	 * @param periodo de emprestimo.
	 ...
	 * @param nomeRequerente do emprestimo.
	 * @param telefoneRequerente do emprestimo.
	 * @param nomeItem a ser devolvido.
	 * @param dataEmprestimo que aconteceu o emprestimo.
	 * @param dataDevolucao do item.
	 * @throws ParseException
	 */
