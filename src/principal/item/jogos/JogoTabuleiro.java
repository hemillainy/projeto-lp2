...
public class JogoTabuleiro extends Item {
	 ...
	 * 
	 * @param peca a peca a ser adicionada. 
	 */
	...
	/**
	 * HashCode que se baseia no nome e na quantidade de pecas perdidas do jogo
	 * de tabuleiro.
	 */
	@Override
	public int hashCode() {
	...
	/**
	 * Equals que se baseia no nome e na quantidade de pecas perdidas do jogo de
	 * tabuleiro.
	 */
	@Override
	...
	public String toString() {
		return "JOGO DE TABULEIRO: " + this.nome + ", R$ " + this.preco + ", " + status.getValor() + ", "
				+ statusCompleto.getValor();
	}
