...
public class UserControllerTest {
	...
	public void testRemoveUsuario() {
		Usuario us1 = new Usuario("Cassio", "4321-5678", "cassio@email.com");
		Usuario us2 = new Usuario("Hemillainy", "5678-5678", "hemillainy@email.com");
		List<Usuario> restantes = new ArrayList<>();
		restantes.add(us1);
		restantes.add(us2);
		uc.removeUsuario("Geovane", "1234-5678");
		assertEquals(restantes, uc.getUsuarios());
	}
	...
	public void testListarTop10MelhoresUsuario() {
		...
		assertEquals("1: Cassio - Reputacao: 500,00|2: Geovane - Reputacao: 10,00|3: Hemillainy - Reputacao: 9,00|", uc.listarTop10MelhoresUsuario());
	}
